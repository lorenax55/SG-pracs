...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    // Método para crear las geometrías y añadir al modelo
    createGeometries() {
        const box = new BoxGeometry(this.gui, "Controles de la Caja");
        this.add(box);
        // Posicionar la caja
        box.position.set(-2, 0, 0);
        this.models.push(box); // Agregar la caja al array de modelos

        const cylinder = new CylinderGeometry(this.gui, "Controles del Cilindro");
        this.add(cylinder);
