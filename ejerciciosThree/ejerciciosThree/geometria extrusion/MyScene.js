...
import { ExtHeart, ExtTube, ExtNoBisel } from './ExtGeometry.js'
...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    createGeometries() {
        ...
        var corazon = new ExtHeart(this.gui, "Corazon");
        this.add(corazon);
        this.models.push(corazon); 


        var tube = new ExtTube(this.gui, "Tubo"); // Crear un tubo en la posición (0, 0, 0)
        tube.position.set(-2, 0, 0);
        this.add(tube);
        this.models.push(tube);



        var noBisel = new ExtNoBisel(this.gui, "No bisel"); // Crear una extrusión sin bisel en la posición (10, 0, 0)
        noBisel.position.set(2, 0, 0);
        this.add(noBisel);
        this.models.push(noBisel);
  ...
  onWindowResize () {
    ...
    update() {
        ...
        // Actualizar el resto de los modelos
        this.models.forEach(model => {
            model.update();
        });

        // Le decimos al renderizador que visualice la escena
